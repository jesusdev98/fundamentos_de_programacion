  ...
  return (
    <section aria-labelledby="quiz-result-title">
      ...
      <div className="mt-10"><h2 className="section-title text-3xl">Revisión de errores</h2>
        {result.incorrect.length === 0 ? <p className="mt-5 rounded-lg border border-emerald-200 bg-emerald-50 p-5 font-bold text-emerald-900">10/10: dominaste todos los temas de este intento.</p> : <div className="mt-5 space-y-5">{result.incorrect.map((item) => {
