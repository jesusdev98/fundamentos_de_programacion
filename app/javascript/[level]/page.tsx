...
export default async function LevelPage({ params }: { params: Promise<{ level: string }> }) {
  ...
  const paths = [
    ...
    { eyebrow: `${level.exercises.length} ejercicios`, title: "Práctica", description: "Escribe y ejecuta el núcleo de JavaScript en un sandbox aislado.", href: `/javascript/${slug}/practica`, linkLabel: "Abrir práctica" },
